...
If audio/video connection works correctly with a Reacts instance located in an external network but not on your internal network, try disabling direct connect between the clients.

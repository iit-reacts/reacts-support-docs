...
---
**Note: Prior to following this instruction please make sure you don't have any Windows updates pending. If you do, install the updates first, restart your device and try again.** 
...
**Step 2:** Ensure that there is no interference between your antivirus software and Reacts that could prevent the software from being launched.

**Step 3:** Enter your proxy information. If you connect though a proxy and you are using Reacts Windows, you may need to manually enter the proxy information into the Reacts settings panel.
...
The majority of installation failures occur when Windows updates are pending or when Microsoft libraries are out of date therefore please make sure you don't have any Windows updates pending. If you do, install the updates first, restart your device and try again. 

To ensure that your Microsoft libraries are up-to- date please follow the steps detailed in our online support documentation found under: 

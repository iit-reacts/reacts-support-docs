...
*   Open **Programs and Features window** and select **Turn Windows features on or off** from the menu on the left side.
...
*   On the advanced settings window under Wireless Adapter Settings/Power Saving Mode set to **On Battery: Maximum Performance** then click **Apply**

...
**INSTALLGIVECONTROL=0**– Do not install the_Allow giving control over shared display_ sub-feature

**INSTALLSHAREDISPLAY=0**– Do not install the_Allow sharing display_or its sub-features

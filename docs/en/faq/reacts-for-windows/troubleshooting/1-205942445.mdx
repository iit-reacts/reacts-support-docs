...
---
 You are trying to configure Audio/Video settings in Reacts but there is no microphone and/or speakers available from the drop down list when opening Audio/Video settings window:

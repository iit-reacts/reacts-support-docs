...
The _**Silent Update System**_ is a Reacts mechanism designed to maintain the Reacts application up-to-date. The service allows _**Philips**_ to deliver security and feature updates in a way that is fast, transparent, consistent, reliable and secure.
...
By default, all new Reacts installations are subscribed to the _**Fastlane**_. Clients that subscribe to the **_Fastlane_** will receive Reacts updates as soon as they are stable and released to the public. Clients that subscribe to the _**Fastlane**_ will benefit from the most up-to-date security and features. 
